    ...
    >
      ...
      >
        ...
        <div className="card-glass rounded-2xl shadow-2xl overflow-hidden animate-slide-in-up">
          <header className="sticky top-0 z-20 bg-gradient-to-r from-primary to-purple-600 backdrop-blur-md border-b border-white/10 px-6 py-4 flex items-center justify-between gap-4">
            <div>
              {title ? (
