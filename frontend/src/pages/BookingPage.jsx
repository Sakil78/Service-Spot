    ...
    async function fetchSlots() {
      try {
        ...
        if (isToday) {
          ...
          filteredSlots = normalized.filter(slot => {
          ...
          console.log('Filtered past slots for today. Available:', filteredSlots.length);
        }
