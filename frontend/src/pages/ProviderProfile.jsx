...
const Toast = ({ message, tone = 'success', onClose }) => (
  <div
    ...
    className={`fixed right-6 bottom-6 z-50 rounded-lg px-4 py-3 shadow-lg transform transition ${
      tone === 'success' ? 'bg-emerald-600 text-gray-900' : 'bg-red-600 text-gray-900'
    }`}
  >
...
export default function ProviderProfile() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] py-8 px-4 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Provider Profile</h1>
          <p className="text-gray-700">Manage your professional information and service details</p>
        </div>

        <form onSubmit={handleSubmit} className="bg-gradient-to-br from-white via-blue-50/50 to-purple-50/50 shadow-lg border-2 border-primary/20 p-8 rounded-2xl">
          ...
          <div className="space-y-6">
            ...
            <div className="border-t border-primary/20 pt-6 mt-6 bg-gradient-to-br from-blue-100 to-blue-50 p-5 rounded-xl">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    disabled={!isEditing}
                    className={`input-field bg-white ${errors.serviceType ? 'border-red-500' : ''}`}
                ...
                {/* Approximate Price */}
                <div>
                  <label htmlFor="approxPrice" className="block text-sm font-medium text-gray-900 mb-2">
                  ...
                  <input
                    ...
                    step="0.01"
                  />
                  {errors.approxPrice && <p className="text-red-600 text-sm mt-1">{errors.approxPrice}</p>}
                </div>
              </div>

              {/* Years of Experience */}
              <div className="mt-6">
                <label htmlFor="yearsExperience" className="block text-sm font-medium text-gray-900 mb-2">
            ...
            <div className="border-t border-primary/20 pt-6 mt-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {/* Door No */}
                <div>
                  <label htmlFor="doorNo" className="block text-sm font-medium text-gray-900 mb-2">
                    Door/Flat Number *
                  </label>
                  <input
                    id="doorNo"
                    ...
                    placeholder="123"
                  />
                  {errors.doorNo && <p className="text-red-600 text-sm mt-1">{errors.doorNo}</p>}
                </div>
              ...
              {/* Address Line */}
              <div className="mt-6">
                <label htmlFor="addressLine" className="block text-sm font-medium text-gray-900 mb-2">
                  Address Line *
                </label>
                <input
                  id="addressLine"
          ...
          <div className="mt-8 pt-6 border-t border-red-500/30">
            ...
            <button
              ...
              className="bg-red-500 hover:bg-red-600 text-gray-900 px-6 py-3 rounded-lg flex items-center gap-2 transition-colors font-medium"
            >
              <Trash2 size={18} />
          ...
          <div className="bg-[#1a1a2e] rounded-2xl max-w-md w-full p-6 shadow-2xl border border-red-500/30">
            ...
            <div className="flex gap-3">
              <button
                ...
                disabled={loading}
                className="flex-1 px-4 py-3 border border-white/20 rounded-lg hover:bg-white/10 transition-colors text-gray-900 font-medium"
              >
                Cancel
              </button>
              <button
                ...
                disabled={loading}
                className="flex-1 bg-red-500 hover:bg-red-600 text-gray-900 px-4 py-3 rounded-lg transition-colors disabled:opacity-50 font-medium"
              >
