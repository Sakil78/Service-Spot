        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(
                    ...
                    "/api/users/*/refresh-coordinates", // Refresh coordinates for specific user
                    "/api/users/admin/refresh-all-coordinates", // Batch refresh coordinates
                    "/api/location/**",                // Location tracking & distance calculation
                    "/error",                          // Error page
